...
interface ProductRevenueDataPoint {
  product_code: string
  revenue_brl: string
  percentage: number
}
...
/**
 * Product revenue chart component displaying revenue amounts by product
...
export function ProductRevenueChart({
  ...
  const chartData = data.map(point => ({
    ...
    value: parseFloat(point.revenue_brl),
  }))
        ...
        <div className='bg-background rounded-lg border p-3 shadow-lg'>
          ...
          <p className='text-sm'>
            ...
            <span className='font-medium'>
              {formatBRL(data.value, { locale, showSymbol: true })}
            </span>
          </p>
          <p className='text-sm'>
      ...
      <ResponsiveContainer width='100%' height='100%'>
        ...
        >
          ...
          <YAxis
            ...
            tickFormatter={value => formatBRL(value, { locale, showSymbol: true })}
          />
