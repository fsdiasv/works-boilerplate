  ...
  ({ className, provider, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          'flex items-center justify-center rounded-md border border-slate-300 bg-white p-2.5 sm:p-3',
          'hover:bg-slate-50 focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:outline-none',
